...
async function GET(request) {
    try {
        ...
        const users = Array.from(new Set(messages.map((msg)=>msg.sender))).filter((username)=>username) // تأكد من أن اسم المستخدم موجود
        .map((username)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4287fbb1._.js.map